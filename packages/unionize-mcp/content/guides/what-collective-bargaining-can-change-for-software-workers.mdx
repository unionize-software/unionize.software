...
when_to_use: "Use when coworkers ask what a union would materially change beyond symbolism."
not_for: "Not for bargaining strategy tailored to one workplace or contract campaign."
collections:
  - "evidence-leverage"
related_slugs:
...
sources:
  - title: "Labor Unions and the U.S. Economy"
    url: "https://home.treasury.gov/news/featured-stories/labor-unions-and-the-us-economy"
    publisher: "U.S. Department of the Treasury"
    kind: "research"
    note: "Treasury synthesis of research on wages, benefits, inequality, workplace voice, and spillover effects."
  - title: "Employer and Union Rights and Obligations"
    ...
    kind: "government"
    note: "NLRB explanation of mandatory subjects, good-faith bargaining, impasse, and the limit that parties need not agree or make concessions."
---
...
Without a bargaining representative, workers may still act together and use other legal or institutional routes. A recognized or certified union adds a statutory bargaining relationship. The NLRB says the parties must bargain in good faith over wages, hours, and other mandatory subjects, while also making clear that neither side is compelled to agree or make concessions.
...
Collective bargaining can convert some recurring management choices into negotiated rules, though the duty to bargain and the resulting contract depend on the subject, the proposal, leverage, and agreement.
...
But collective bargaining changes the baseline. It gives workers a durable mechanism for proposing and negotiating workplace rules instead of addressing each decision only as an individual request. The [NLRB's bargaining overview](https://www.nlrb.gov/about-nlrb/rights-we-protect/your-rights/employer-union-rights-and-obligations) is the legal footing for that claim; Treasury's review supplies the empirical claims about wages, benefits, inequality, and spillovers.
