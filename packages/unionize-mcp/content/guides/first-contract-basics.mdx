...
sources:
  - title: "Employer and Union Rights and Obligations"
    ...
    kind: "government"
    note: "NLRB explanation of good-faith bargaining, mandatory subjects, impasse, and the rule that neither party is compelled to agree or make concessions."
  - title: "Frequently Asked Questions"
    url: "https://www.nlrb.gov/resources/faq/nlrb"
    publisher: "National Labor Relations Board"
    kind: "government"
    note: "Current NLRB orientation to collective bargaining and representation procedures."
---
...
In the federal private-sector lane, the employer and union must meet at reasonable times and bargain in good faith over wages, hours, and other mandatory subjects. The [NLRB's current bargaining overview](https://www.nlrb.gov/about-nlrb/rights-we-protect/your-rights/employer-union-rights-and-obligations) also states an important limit: the law does not compel either side to reach agreement or make a concession. The rest of this page is practice guidance for maintaining a worker mandate inside that legal process.
