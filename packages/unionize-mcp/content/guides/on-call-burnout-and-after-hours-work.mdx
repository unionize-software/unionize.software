...
risk_level: "medium"
source_status: "mixed"
when_to_use: "Use when availability pressure, pager load, or after-hours work is becoming a collective workplace issue."
not_for: "Not for personal productivity advice or general wellness guidance."
collections:
  - "issue-guides"
related_slugs:
...
sources:
  - title: "Fact Sheet 22: Hours Worked Under the Fair Labor Standards Act"
    ...
    kind: "government"
    note: "DOL guidance on compensable work time, including on-call time and work performed outside a scheduled shift."
  - title: "Long Work Hours, Extended or Irregular Shifts, and Worker Fatigue"
    url: "https://www.osha.gov/worker-fatigue"
    publisher: "Occupational Safety and Health Administration"
    kind: "government"
    note: "OSHA overview connecting long or irregular schedules with fatigue, health, injury, and accident risk."
---
...
## Separate workload evidence from wage-law conclusions

For covered, nonexempt employees, the Fair Labor Standards Act generally requires overtime pay after 40 hours in a workweek. The Department of Labor's [hours-worked fact sheet](https://www.dol.gov/agencies/whd/fact-sheets/22-flsa-hours-worked) says on-call time on an employer's premises counts as work; at-home on-call time usually does not, unless the restrictions on the worker's freedom are substantial enough to change the result. Actual work performed while on call may still be compensable.

Software job titles and salary status do not answer exemption or compensability questions by themselves. State law can provide different or additional rules. Track the facts, then get wage-law advice before declaring that a particular rotation is legal or illegal.

There is also a safety dimension that does not depend on a wage claim. [OSHA's worker-fatigue overview](https://www.osha.gov/worker-fatigue) links long or irregular shifts with fatigue and increased health, injury, and accident risks.
