...
sources:
  - title: "Your Right to Discuss Wages"
    url: "https://www.nlrb.gov/about-nlrb/rights-we-protect/your-rights/your-rights-to-discuss-wages"
    publisher: "National Labor Relations Board"
    kind: "government"
    note: "NLRB employee-facing explanation of covered workers' right to discuss wages, with stated limits and exclusions."
  - title: "Federal Laws Prohibiting Job Discrimination"
    ...
    kind: "government"
    note: "EEOC overview of federal protections in compensation, promotion, assignment, classification, layoff, and other employment decisions."
---
...
For workers covered by the NLRA, the NLRB says wage discussions with coworkers are generally protected, subject to coverage and context. Its [wage-discussion page](https://www.nlrb.gov/about-nlrb/rights-we-protect/your-rights/your-rights-to-discuss-wages) also lists limits, including that supervisors and certain other workers are outside the Act. Separately, federal anti-discrimination law can apply to compensation, promotion, assignment, classification, and layoff decisions; the [EEOC's federal-law overview](https://www.eeoc.gov/fact-sheet/federal-laws-prohibiting-job-discrimination-questions-and-answers) summarizes that framework. Neither source proves that an opaque or unfair decision was unlawful.
