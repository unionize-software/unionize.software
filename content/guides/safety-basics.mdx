...
The NLRB's [concerted-activity overview](https://www.nlrb.gov/about-nlrb/rights-we-protect/the-law/employees/concerted-activity) gives the federal private-sector starting point and identifies conduct that can lose protection. Use this page to lower avoidable risk, then use the rights and status pages to check the lane you are actually in.
