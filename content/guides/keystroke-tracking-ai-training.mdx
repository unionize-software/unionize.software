...
That framing is organizing guidance, not a conclusion that the monitoring is illegal. Covered employees may have NLRA protection when they [act together about monitoring and other working conditions](https://www.nlrb.gov/about-nlrb/rights-we-protect/the-law/employees/concerted-activity). If an automated system affects hiring, pay, promotion, discipline, or another employment decision, federal anti-discrimination law may also matter; the [EEOC's AI and ADA hub](https://www.eeoc.gov/eeoc-disability-related-resources/artificial-intelligence-and-ada) explains one part of that framework.

Do not rely on the NLRB General Counsel's 2022 monitoring memo as current authority. The agency [rescinded it on February 14, 2025](https://www.nlrb.gov/news-outreach/news-story/gc-25-05-rescission-of-certain-general-counsel-memoranda).
